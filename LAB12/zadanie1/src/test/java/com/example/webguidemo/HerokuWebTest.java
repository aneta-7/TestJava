...
public class HerokuWebTest extends JUnitStories {

	private WebDriverProvider driverProvider = new TypeWebDriverProvider(FirefoxDriver.class);
	private WebDriverSteps lifecycleSteps = new PerStoryWebDriverSteps(driverProvider); // or
	...
	public Configuration configuration() {
		...
		return new SeleniumConfiguration().useSeleniumContext(context).useWebDriverProvider(driverProvider)
				...
				.useStoryLoader(new LoadFromClasspath(embeddableClass)).useStoryReporterBuilder(
	...
	public InjectableStepsFactory stepsFactory() {
		...
		return new InstanceStepsFactory(configuration, new HerokuSteps(pages), lifecycleSteps,
